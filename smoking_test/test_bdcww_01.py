...
#===================================================================
#填写权利人
driver.find_element_by_id("qwrxm1").send_keys(u'张三')
time.sleep(1)
...
#填写法人代表
driver.find_element_by_id("fddbr1").send_keys(u'张三三')
time.sleep(1)
...
#填写代理人姓名
driver.find_element_by_id("dlrxm1").send_keys(u'张三三三')
time.sleep(1)
...
#======================================================================
#填写义务人
driver.find_element_by_id("ywrxm1").send_keys(u'李四')
time.sleep(1)
...
#填写法人代表
driver.find_element_by_id("yfddbr1").send_keys(u'李四四')
time.sleep(1)
...
#填写代理人姓名
driver.find_element_by_id("ydlrxm1").send_keys(u'李四四四')
time.sleep(1)
...
driver.find_element_by_xpath('//*[@id="bdcsqb-form"]/table/tbody/tr[16]/td[4]/div/ul/li[1]').click()
time.sleep(1)

#填写宗地面积
driver.find_element_by_id("zdzhmj").send_keys("5000")
time.sleep(1)

#选择宗地用途住宿餐饮用地
driver.find_elements_by_class_name("input-group-addon")[3].click()
driver.find_element_by_xpath('//*[@id="bdcsqb-form"]/table/tbody/tr[17]/td[4]/div/ul/li[15]').click()
time.sleep(1)

#填写定着物面积
driver.find_element_by_id("dzwmj").send_keys("3000")
time.sleep(1)

#选择定作物用途为别墅
driver.find_elements_by_class_name("input-group-addon")[4].click()
driver.find_element_by_xpath('//*[@id="bdcsqb-form"]/table/tbody/tr[18]/td[4]/div/ul/li[3]').click()
time.sleep(1)

#选择宗地权利性质为授权经营
driver.find_elements_by_class_name("input-group-addon")[5].click()
driver.find_element_by_xpath('//*[@id="bdcsqb-form"]/table/tbody/tr[19]/td[2]/div/ul/li[6]').click()
time.sleep(1)

#选择用海类型为船舶工业用海
driver.find_elements_by_class_name("input-group-addon")[6].click()
driver.find_element_by_xpath('//*[@id="bdcsqb-form"]/table/tbody/tr[19]/td[4]/div/ul/li[8]').click()
time.sleep(1)

#选择构筑物类型为海上构筑物
driver.find_elements_by_class_name("input-group-addon")[7].click()
driver.find_element_by_xpath('//*[@id="bdcsqb-form"]/table/tbody/tr[20]/td[2]/div/ul/li[6]').click()
time.sleep(1)

#选择林种为经济林
driver.find_elements_by_class_name("input-group-addon")[8].click()
driver.find_element_by_xpath('//*[@id="bdcsqb-form"]/table/tbody/tr[20]/td[4]/div/ul/li[3]').click()
time.sleep(1)
