...
#预售商品房买卖预告登记
driver.find_element_by_xpath('//*[@id="content-index"]/div[1]/a[2]/div/span[2]').click()
time.sleep(1)

#共有方式为共同拥有
driver.find_element_by_xpath('//*[@id="bdcsqb-form"]/div/label[3]').click()
time.sleep(1)

driver.find_element_by_id("qlradd").click()
time.sleep(1)
...
driver.find_element_by_id("qwrxm3").send_keys(u'张四'+str(nowTime))
time.sleep(1)

#填写共有比例
driver.find_element_by_id("gybl3").send_keys("50")
time.sleep(1)
...
#填写身份证号
driver.find_element_by_id("zjh3").send_keys("320104198905241415")
time.sleep(1)

#填写通讯住址
driver.find_element_by_id("txdz3").send_keys(u'南京爬山虎ajiojadjaJJSKKDFA上纠结发肌肤大海')
time.sleep(1)

#填写邮编
driver.find_element_by_id("yb3").send_keys('125243214')
time.sleep(1)

#填写法人代表
driver.find_element_by_id("fddbr3").send_keys(u'张三三'+str(nowTime))
time.sleep(1)

#填写联系电话
driver.find_element_by_id("flxdh3").send_keys("123456789")
time.sleep(1)

#填写代理人姓名
driver.find_element_by_id("dlrxm3").send_keys(u'张三三三'+str(nowTime))
time.sleep(1)

#填写联系电话
driver.find_element_by_id("dlxdh3").send_keys("987654321")
time.sleep(1)

#填写代理机构
driver.find_element_by_id("dljg3").send_keys(u'江苏爬山虎案件点击阿达')
time.sleep(1)
...
driver.find_element_by_xpath('//*[@id="bdcsqb-form"]/table/tbody/tr[31]/td[2]/div/ul/li[1]').click()
time.sleep(1)
